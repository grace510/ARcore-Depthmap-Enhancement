...
parser.add_argument("--logdir", type=str, default="checkpoint", help='path of log files') #default="logs/RUN-S-15"
parser.add_argument("--test_data", type=str, default='/ssd2/eh.kim/simkinect-master_original/simkinect-master/data-for-test', help='test on Set12 or Set68')
#parser.add_argument("--test_data_GT", type=str, default='/ssd2/eh.kim/simkinect-master_original/simkinect-master/data-for-test/GT', help='test on Set12 or Set68')
...
def main():
    ...
    a = torch.load(glob.glob(os.path.join(opt.logdir, 'net_39.6543.pth'))[0])
